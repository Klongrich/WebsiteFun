...
export const GetAreasOfIntrest = ({
  width,
  contentVersion,
  browserInfo,
  ipAdress,
  ...
  if (contentVersion && width < 999) {
    ...
    return (
      <>
        <DesktopBackground>
          <h2 Style="margin-bottom: 110px; text-align:center; font-size:42px; padding-top:10px;">
            {" "}
            Areas Of Interest{" "}
          </h2>
          <Container>
      ...
      <>
        <TestBackground Image={softwareBackground}>
          ...
          <p Style="font-size:25px;">
            (Expermential Not sure If I like the one page format or not)
          </p>
        </TestBackground>
        ...
        <TestBackground Image={stocksBackground}>
          ...
          <p>
            {" "}
            Information That I have learned in the stock market over the past 5
            years
          </p>
        </TestBackground>
